...
disp(" ");
disp("Para esse exercicio iremos carregar 3 matrizes distintas, analizar a esparsidade de cada uma e suas respectivas decomposicoes.");
disp(" ");
...
disp(" ");
disp("Para esse exercicio iremos utilizar as mesmas matrizes para calcular a solucao de Ax = b, onde b é igual a vetor de 1 vezes a matriz dos coeficientes e em seguida calcular a norma maxima.");
...
%%%%%%%%%%%%%% CONCLUSAO LETRA B %%%%%%%%%%%%%%
disp(" ");
disp("O valor da norma obtido para cada uma das tres matrizes eh conveniente uma vez que é muito pequeno o que bate com a intuicao visto que x é a solucao exata para Ax = b.");
disp("Vale salientar que x apresentou solucao exata para todos os casos mas poderia ocorrer uma pequena diferenca em relacao ao valor esperado devido a erro de ponto flutuante.");
disp(" ");
